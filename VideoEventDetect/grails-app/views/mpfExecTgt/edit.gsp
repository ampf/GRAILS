...
<div class="nav"><span class="menuButton"><a class="home"
  ...
  class="list" action="list">MpfExecTgt List</g:link></span> <span
  class="menuButton"><g:link class="create" action="create">New MpfExecTgt</g:link></span>
</div>
-->
<div class="body">
...
<g:if test="${flash.message}">
  ...
  <table>
    <tbody>
      ...
      <tr class="prop">
        <td valign="top" class="name"><label for="currentTasks">Current Tasks:</label></td>
        <td valign="top"
          class="value ${hasErrors(bean:mpfExecTgtInstance,field:'currentTasks','errors')}">
        <input type="text" id="currentTasks" name="currentTasks"
          value="${fieldValue(bean:mpfExecTgtInstance,field:'currentTasks')}" />
        </td>
      </tr>
      ...
      <tr class="prop">
        ...
        <input type="text" id="username" name="username"
          value="${fieldValue(bean:mpfExecTgtInstance,field:'username')}" />
            ...
            <tr class="prop">
        <td valign="top" class="name"><label for="execDir">Target
        Execution Dir:</label></td>
        <td valign="top"
          class="value ${hasErrors(bean:mpfExecTgtInstance,field:'execDir','errors')}">
        <input type="text" id="execDir" name="execDir"
          value="${fieldValue(bean:mpfExecTgtInstance,field:'execDir')}" />
        </td>
      </tr>
      <tr class="prop">
