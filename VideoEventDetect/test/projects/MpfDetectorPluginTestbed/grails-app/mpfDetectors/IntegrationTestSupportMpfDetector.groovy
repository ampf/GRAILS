...
class IntegrationTestSupportMpfDetector extends MpfDetector {
  ...
  def ANT_COPY_TO_SUPPORT = {
      fileset(dir:"${MPF_DETECTORS_HOME}/IntegrationTestSupportMpfDetector/runtime")
  }

  /* The Run_IntegrationTestSupportMpfDetector.sh shell script will operate from the scripts/ dir of the exec tgt,
     ...
     You must supply a script to be sourced by the Run_IntegrationTestSupportMpfDetector.sh and identify it in the
