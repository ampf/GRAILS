<html>
    <head>
        ...
        <!-- style to hide any secondary nav bar (from templates inside templates) -->
        <style type="text/css"> 
    ...
    <body>
        ...
        <div class="logo"><img src="${resource(dir:'images',file:'vedTestLogo.png')}" alt="MpfPluginTestbed" /></div>
                <div class="nav">
            ...
            <span class="menuButton"><g:link class="list" controller="mpfExecTgtStats" action="list">Running Tasks</g:link></span>
        </div>
        <g:layoutBody />
    </body>
</html>