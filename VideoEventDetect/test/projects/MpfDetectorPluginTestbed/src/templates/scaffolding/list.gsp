                ...
                <table>
                    ...
                    <g:each in="\${${propertyName}List}" status="i" var="${propertyName}">
                        ...
                        <%      } else if(i < COLS) { %>
                            ...
                            %>
                                <g:link controller="${p.referencedDomainClass?.propertyName}" action="show" id="\${${propertyName}?.${p.name}?.id}">\${fieldValue(bean:${propertyName}, field:'${p.name}').replaceAll(".*\\\\.","")}</g:link>
                            <% } else {
