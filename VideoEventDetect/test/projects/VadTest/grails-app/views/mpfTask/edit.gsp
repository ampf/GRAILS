  ...
  <table>
    <tbody>
      ...
      <tr class="prop">
        ...
        <input type="text" id="statusMsg" name="statusMsg" size="80"
      ...
      <tr class="prop">
        ...
        <input type="text" id="sourcekey" name="sourcekey" size="80"
      ...
      <tr class="prop">
        ...
        <input type="text" id="remoteStagingDir" name="remoteStagingDir" size="80"
