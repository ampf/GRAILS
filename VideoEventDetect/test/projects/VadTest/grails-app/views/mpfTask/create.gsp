...
<g:if test="${flash.message}">
  ...
  <table>
    <tbody>
      ...
      <tr class="prop">
        <td valign="top" class="name"><label for="detectPrefix">Detector
        Prefix:</label></td>
        <td valign="top"
      ...
      <tr class="prop">
        ...
        <input type="text" id="timeout" name="timeout"
          value="${fieldValue(bean:mpfTaskInstance,field:'timeout')}" />
        (blank is no timeout; use d, m, h, s suffixes )</td>
      </tr>
      ...
      <tr class="prop">
        <td valign="top" class="name"><label for="foregroundThread">Use
        Foreground Thread:</label></td>
        <td valign="top"
      ...
      <tr class="prop">
        ...
        <g:select name="execTgt.id" from="${targets}" optionKey="id"
          optionValue="tgtName"></g:select></td>
      </tr>
      <tr class="prop">
