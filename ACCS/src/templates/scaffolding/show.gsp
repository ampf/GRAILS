...
<html>
    ...
    <body>
        <div class="nav">
            ...
            <span class="menuButton"><g:link class="create" action="copy">Copy ${className}</g:link></span>
        </div>
        <div class="body">
                    ...
                    <%
                        ...
                        <tr class="prop">
                            ...
                            <%  } else  { 
                                    ...
                                    if (cp?.password) {
                            %>
                            <td valign="top" class="value">\${fieldValue(bean:${propertyName}, field:'${p.name}').replaceAll(/./,"*")}</td>
                            <%
                                    } else {
                            %>
